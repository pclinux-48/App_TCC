...
const projectCards: ProjectCard[] = [
  ...
  },
  {
    ...
    description:
      'Propõe uma arquitetura de baixo custo para ampliar o acesso a automacao residencial e seguranca domestica.',
  ...
  },
  {
    ...
    category: 'frontend',
    categoryLabel: 'Frontend',
    title: 'Divulgacao do impacto do TCC',
    description:
      'Apresenta beneficios sociais e tecnicos do projeto, reforcando a popularizacao da automacao residencial.',
        ...
        <div class="row align-items-center g-5">
          <div class="col-lg-6">
            ...
            <h1 class="display-5 fw-bold mb-3">
              Popularizacao da Automacao Residencial com Monitoramento e Intrusao baseado em IoT e Protocolos Web
            </h1>
            <p class="lead text-secondary mb-4">
              O projeto investiga como recursos de automacao, sensores e comunicacao web podem tornar a seguranca
              residencial mais acessivel, conectada e viavel para diferentes perfis de usuarios.
            </p>
            ...
            <div class="row g-3">
              <div class="col-sm-6">
                <div class="info-box h-100 p-3 rounded-4">
                  ...
                  <p class="mb-0">Hoje e ${formatFullDate(today)}</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="info-box h-100 p-3 rounded-4">
                  ...
                  <p class="mb-0">
                    Faltam <strong>${calculateRemainingDays(tccDeliveryDate, today)} dias</strong> para a entrega
                    prevista.
                  </p>
                </div>
              </div>
            ...
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body p-4 p-lg-5">
                ...
                <p class="text-secondary mb-3">
                  Este TCC busca aproximar o conceito de automacao residencial da realidade cotidiana por meio de uma
                  proposta de monitoramento e deteccao de intrusao baseada em IoT.
                </p>
                <p class="text-secondary mb-0">
                  A ideia e integrar sensores, comunicacao por protocolos web e uma interface de acompanhamento para
                  oferecer mais seguranca, visibilidade e baixo custo de implementacao em ambientes residenciais.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-5">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body p-4 p-lg-5">
                ...
                <ul class="mb-0 ps-3">
                  <li class="mb-2">Popularizar a automacao residencial com foco em acessibilidade.</li>
                  <li class="mb-2">Monitorar eventos de intrusao com dispositivos conectados.</li>
                  <li class="mb-2">Usar protocolos web para integrar sensores e aplicacao.</li>
                  <li class="mb-0">Demonstrar valor academico e pratico do projeto para a banca.</li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center gap-3 mb-4">
          <div>
            ...
            <p class="text-secondary mb-0">
              Os cards abaixo podem ser filtrados por categoria usando a funcionalidade implementada em TypeScript.
            </p>
          </div>
      ...
      <div class="container">
        <div class="row g-4">
          <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body p-4">
                ...
                <p class="text-secondary mb-0">
                  HTML, Bootstrap e TypeScript para construir uma interface clara, responsiva e reutilizavel.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card border-0 shadow-sm h-100">
              <div class="card-body p-4">
                <h2 class="h4">Comunicacao Web</h2>
                <p class="text-secondary mb-0">
                  APIs e protocolos web para integracao entre hardware, servidor e painel de monitoramento.
                </p>
              </div>
            </div>
          </div>
  ...
  <footer id="contato" class="py-4 text-bg-dark">
    <div class="container">
      <div class="row g-3 align-items-center">
        <div class="col-lg-8">
          <h2 class="h5 mb-2">Informacoes do aluno</h2>
          <p class="mb-1">Nome: Paulo Cesar</p>
          <p class="mb-1">Semestre: 2026.1</p>
          <p class="mb-1">Curso: Atualize com o nome do seu curso</p>
          <p class="mb-0">E-mail: seuemail@exemplo.com</p>
        </div>
